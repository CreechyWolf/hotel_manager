...
public class HotelManager 
{
	...
	public void viewDetails() 
	{
		...
		try {
			while (rs.next()) 
			{
				...
				System.out.println(hotelName + " has " + hotelNoRooms + " number of rooms and "
	...
	public void viewBookings() 
	{
		...
		try {
			while (rs.next()) 
			{
				...
				String hotelName = rs.getString("name");
				System.out.println(customerName + " is booked in to " + hotelName + " from " + 
						customerStartTime + " to " + customerEndTime + ". Email address: " + customerEmail);
			}
		} catch (SQLException e) {
	...
	{
		Object[] parameters = {booking.getCustomerName(), booking.getCustomerEmail(), booking.getStartDateTime(),
				booking.getEndDateTime(), booking.getHotelid()};
		//add a booking
